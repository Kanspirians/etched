...
public class ItemModelGen implements DataProvider {
    ...
    private void register() {
        ...
        this.generateFlatItem(EtchedRegistry.JUKEBOX_MINECART.get(), ModelTemplates.FLAT_ITEM);
        this.generateFlatItem(EtchedRegistry.BOOMBOX.get(), ModelTemplates.FLAT_ITEM);
    }
