...
public class Etched {
    ...
    public static void clientInit() {
        ...
        RegistryBridge.registerModel(new ModelResourceLocation(new ResourceLocation(Etched.MOD_ID, "boombox_in_hand"), "inventory"));
    }
    ...
    public static void clientPostInit() {
        ...
        RegistryBridge.registerItemOverride(EtchedRegistry.BOOMBOX.get(), new ResourceLocation(Etched.MOD_ID, "playing"), (stack, level, livingEntity) -> BoomboxItem.isPlaying(stack) ? 1 : 0);
